...
For more details about specific classes and the signals please refer to the documentation found in the "docs folder":https://github.com/pederan/robotlegs-extensions-view-utility/tree/master/docs.
...
All you need is your main context class to extend @ViewSignalContext@. This enables the automatic mediator creation and maps the signals used for communication. That's all and you are good to go. For a list of all methods and features please read the "documentation":https://github.com/pederan/robotlegs-extensions-view-utility/tree/master/docs. Also make sure to check out the source code in the "src_example folder":https://github.com/pederan/robotlegs-extensions-view-utility/tree/master/src_examples/ for "how to use". The examples can be checked out "here":http://mfcampaign.net/pederan/robotlegs-extensions-view-utility/. 
